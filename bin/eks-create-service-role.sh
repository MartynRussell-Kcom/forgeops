...
EKS_SERVICE_ROLE_ARN=$(aws iam create-role --role-name ${EKS_SERVICE_ROLE} --description "Allows EKS to manage clusters on your behalf." --assume-role-policy-document file://../etc/eks-service-role.json --query 'Role.Arn')
