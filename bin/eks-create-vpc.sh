...
echo "SecurityGroups: This security group allows the EKS cluster to communicate with your worker nodes. Value should be set to EKS_CONTROL_PLANE_SECURITY_GROUP in your eks-env.cfg file."
...
echo "NOTE: If using a private zone in Route53, please create it now (if not created yet)."
